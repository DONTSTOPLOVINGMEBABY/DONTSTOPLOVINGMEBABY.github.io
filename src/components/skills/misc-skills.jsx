...
function MiscSkillsSection() {
  ...
  return (
    <SkillCategory>
      ...
      <CategorySkills>
        <SkillRow>
          <SingleSkill icon={jest_svg} name="Jest" />
          <SingleSkill icon={firebase_svg} name="Firebase" />
        </SkillRow>
        <SkillRow>
          <SingleSkill icon={git_svg} name="Git" />
          {flagsReady ? (
            aws ? (
              <SingleSkill icon={aws_svg} name="AWS" />
            ) : (
              <SingleSkill icon={railway_svg} name="Railway" />
            )
          ) : null}
          <SingleSkill icon={docker_svg} name="Docker" />
        </SkillRow>
        <SkillRow>
          <SingleSkill icon={webpack_svg} name="Webpack" />
          <SingleSkill icon={styled_components_svg} name="Styled Components" />
        </SkillRow>
      </CategorySkills>
    </SkillCategory>
  );
